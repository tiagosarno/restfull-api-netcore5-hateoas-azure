...
{
    public class ScheduleEnricher : ContentResponseEnricher<ScheduleVO>
    {
        private readonly object _lock = new object();

        protected override Task EnrichModel(ScheduleVO content, IUrlHelper urlHelper)
        {
            var path = "api/schedule/v1";
